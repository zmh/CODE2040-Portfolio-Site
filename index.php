<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Zach Hamed ♥ CODE2040</title>
        <meta name="description" content="A fun project.">
        <meta name="author" content="Zachary Hamed">
    ...
    <body>
        ...
        <div class="logo">
            <img class="logo-arrow" src="img/code2040-arrow.png" height="40px;" />
            <img class="logo-main" src="img/code2040-logo.png" height="40px;" />
        </div>
        ...
        <div class="laptop-body">
            ...
            <div class="viewport"><img src="img/screen2.png" width="100%" /></div>
        </div>
        
        <div class="hideme finder">
